...
def load_model(model_config_path: str, model_checkpoint_path: str, device: str = "cuda" if torch.cuda.is_available() else ("mps" if torch.backends.mps.is_available() else "cpu")):
